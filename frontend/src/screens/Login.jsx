...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-surface-900">
            {/* Orbs */}
            <div className="absolute w-96 h-96 -top-48 -left-32 rounded-full bg-accent/30 blur-[80px] animate-float" />
            <div className="absolute w-80 h-80 -bottom-32 -right-24 rounded-full bg-surface-600/50 blur-[80px] animate-float" style={{ animationDelay: '4s' }} />
                ...
                <div className="bg-white/5 border border-surface-700/50 shadow-xl rounded-2xl p-8 md:p-10">
                    ...
                    <div className="text-center mb-8">
                        <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-accent flex items-center justify-center">
                            <i className="ri-chat-smile-2-fill text-xl text-white"></i>
                        </div>
                        <h1 className="text-3xl font-display text-surface-50 mb-2">Welcome back!</h1>
